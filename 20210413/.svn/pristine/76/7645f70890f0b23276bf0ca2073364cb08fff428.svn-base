...
/* zdb IPV6 */
#define FTPLIB_IPV4 1
#define FTPLIB_IPV6 2
...
GLOBALDEF int FtpOpts(const char *opts, netbuf *nControl);  //zdb
GLOBALREF int FtpConnect6(const char *host, netbuf **nControl);
