 ...
 * *
 * *******************************************************************************************/
#ifndef __DBSYNC_TASK_DEBUG_H__
#define __DBSYNC_TASK_DEBUG_H__
...
#define DBSYNC_TASK_SUCCESS true
#define DBSYNC_TASK_FAILED false
...
#define DBSYNC_UPDATE_URL "http://%d.0.0.254:8081/strategy/updateStrategy"
#define DBSYNC_INSERT_URL "http://%d.0.0.254:8081/strategy/addStrategy"
#define DBSYNC_TIME_URL "http://%d.0.0.254:8081/strategy/setTimeSync"
#define DBSYNC_SETLOG_URL "http://%d.0.0.254:8081/strategy/setLogSwitch"
#define DBSYNC_STATUS_URL "http://%d.0.0.254:8081/strategy/health"
...
*注释:
*******************************************************************************************/
int32 dbsync_update_taskinfo_debug(int32 taskcnt, pdbsync_task tasks, pchar cfg = DBConfigFile);
/*******************************************************************************************
*功能:   备份策略信息
*参数:
*    taskcnt        新策略个数
