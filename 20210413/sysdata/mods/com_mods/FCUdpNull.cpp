...
bool CUDPNULL::DoMsg(unsigned char *sdata, int slen, char *cherror, int *pktchange, int bFromSrc)
{
    if (bFromSrc == 1) {
...
bool CUDPNULL::DoSrcMsg(unsigned char *sdata, int slen, char *cherror)
{
...
bool CUDPNULL::DoDstMsg(unsigned char *sdata, int slen, char *cherror)
{
    return true;
}
